...
loc_A2FE:                               ; ...
                ...
                mov     al, [bx+0ED20h]
                mov     [di], al
                test    [si+monster.field_5], 40h
                jz      short loc_A340
                test    hit_monster_flags, 80h
                jnz     short loc_A340
                mov     al, [si+monster.field_5]
                and     al, 1Fh
