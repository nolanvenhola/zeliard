...
tile_type_tbl	equ	32EBh			;* tile type dispatch table (word[4])	;* DBG: DBG_CHUNK_BASE + offset tile_type_tbl_lbl
render_fn_tbl_a	equ	35BEh			;* render function pointer table A (word[N])	;* DBG: DBG_CHUNK_BASE + offset render_fn_tbl_a_lbl
render_fn_tbl_b	equ	361Ah			;* render function pointer table B (word[N])	;* DBG: DBG_CHUNK_BASE + offset render_fn_tbl_b_lbl
...
tile_row_ctr	equ	3BB3h			;* current tile row counter (byte, 0..1Ch)	;* DBG: DBG_CHUNK_BASE + offset tile_row_ctr_lbl
tile_col_ctr	equ	3BBAh			;* current tile column counter (word)	;* DBG: DBG_CHUNK_BASE + offset tile_col_ctr_lbl
char_render_buf	equ	3BBCh			;* character/sprite render buffer
text_render_buf	equ	3BE4h			;* text glyph render buffer
tile_cache_tbl	equ	3D4Ch			;* tile VGA address cache table (word[N])	;* DBG: DBG_CHUNK_BASE + offset tile_cache_tbl_lbl
tile_disp_tbl	equ	3E80h			;* tile column displacement table (word[N])	;* DBG: DBG_CHUNK_BASE + offset tile_disp_tbl_lbl
...
; ----------------------------------------------------------------------
tile_state_flag	equ	3628h			;* tile state flag byte	;* DBG: DBG_CHUNK_BASE + offset tile_state_flag_lbl
tile_idx_a	equ	3BB4h			;* tile index A (byte)	;* DBG: DBG_CHUNK_BASE + offset tile_idx_a_lbl
tile_idx_b	equ	3BB7h			;* tile index B (byte, 0FDh = none)	;* DBG: DBG_CHUNK_BASE + offset tile_idx_b_lbl
