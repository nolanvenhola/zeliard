...
mask_tbl_a	equ	32B9h	;* DBG: DBG_CHUNK_BASE + offset mask_tbl_a_lbl
mask_tbl_b	equ	32C1h	;* DBG: DBG_CHUNK_BASE + offset mask_tbl_b_lbl
sprite_frame_tbl	equ	3617h	;* DBG: DBG_CHUNK_BASE + offset sprite_frame_tbl_lbl
sprite_src_tbl	equ	3619h	;* DBG: DBG_CHUNK_BASE + offset sprite_src_tbl_lbl
move_seq_up	equ	3B1Fh			;* DBG: DBG_CHUNK_BASE + offset move_seq_up_lbl
move_seq_horiz	equ	3BE3h			;*
scroll_col_tbl	equ	3C16h	;* DBG: DBG_CHUNK_BASE + offset scroll_col_tbl_lbl
scroll_row_tbl	equ	3C17h	;* DBG: DBG_CHUNK_BASE + offset scroll_row_tbl_lbl
pal_r_reg	equ	4289h	;* DBG: DBG_CHUNK_BASE + offset pal_r_reg_lbl
pal_g_reg	equ	428Ah	;* DBG: DBG_CHUNK_BASE + offset pal_g_reg_lbl
pal_b_reg	equ	428Bh	;* DBG: DBG_CHUNK_BASE + offset pal_b_reg_lbl
cur_pal_ptr	equ	44F8h	;* DBG: DBG_CHUNK_BASE + offset cur_pal_ptr_lbl
cur_col_ctr	equ	4505h	;* DBG: DBG_CHUNK_BASE + offset cur_col_ctr_lbl
cur_row_ctr	equ	4506h	;* DBG: DBG_CHUNK_BASE + offset cur_row_ctr_lbl
cur_pass_ctr	equ	4507h	;* DBG: DBG_CHUNK_BASE + offset cur_pass_ctr_lbl
render_fn_ptr	equ	450Bh	;* DBG: DBG_CHUNK_BASE + offset render_fn_ptr_lbl
saved_di	equ	450Dh	;* DBG: DBG_CHUNK_BASE + offset saved_di_lbl
saved_es	equ	450Fh	;* DBG: DBG_CHUNK_BASE + offset saved_es_lbl
...
; ----------------------------------------------------------------------
cur_pal_idx	equ	44FAh	;* DBG: DBG_CHUNK_BASE + offset cur_pal_idx_lbl
src_word_a	equ	44FBh	;* DBG: DBG_CHUNK_BASE + offset src_word_a_lbl
src_word_b	equ	44FDh	;* DBG: DBG_CHUNK_BASE + offset src_word_b_lbl
src_word_c	equ	44FFh	;* DBG: DBG_CHUNK_BASE + offset src_word_c_lbl
src_word_d	equ	4501h	;* DBG: DBG_CHUNK_BASE + offset src_word_d_lbl
mask_word	equ	4503h	;* DBG: DBG_CHUNK_BASE + offset mask_word_lbl
render_mode_flag	equ	4508h	;* DBG: DBG_CHUNK_BASE + offset render_mode_flag_lbl
...
disp_scroll_a:					;* Dispatcher entry: scroll function A
		...
		db	2Eh					; CS segment override prefix (with next 2 bytes = MOV DS,[BX])
				; label offset used as plane B displacement in render_ab_buf_loop
scroll_a_plane_b	dw	1E8Eh		; Bytes 8Eh,1Eh = MOV DS,[BX] in disp_scroll_a code
