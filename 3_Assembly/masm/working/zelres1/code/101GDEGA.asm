...
mask_tbl_a	equ	32A7h	;* DBG: DBG_CHUNK_BASE + offset mask_tbl_a_lbl
mask_tbl_b	equ	32AFh	;* DBG: DBG_CHUNK_BASE + offset mask_tbl_b_lbl
sprite_src_tbl	equ	35ADh	;* DBG: DBG_CHUNK_BASE + offset sprite_src_tbl_lbl
sprite_frame_tbl	equ	35AFh	;* DBG: DBG_CHUNK_BASE + offset sprite_frame_tbl_lbl
palette_xlat_tbl	equ	35CDh			;*
move_seq_up	equ	DBG_CHUNK_BASE + offset ega_palette_seq_tbl		;*
move_seq_horiz	equ	3B30h			;*
color_pair_tbl_lo	equ	3B63h	;* DBG: DBG_CHUNK_BASE + offset color_pair_tbl_lo_lbl
color_pair_tbl_hi	equ	3B64h	;* DBG: DBG_CHUNK_BASE + offset color_pair_tbl_hi_lbl
ega_palette_buf	equ	416Ah	;* DBG: DBG_CHUNK_BASE + offset ega_palette_buf_lbl
cur_col_ctr	equ	4210h	;* DBG: DBG_CHUNK_BASE + offset cur_col_ctr_lbl
cur_color	equ	4211h	;* DBG: DBG_CHUNK_BASE + offset cur_color_lbl
cur_row_ctr	equ	4212h	;* DBG: DBG_CHUNK_BASE + offset cur_row_ctr_lbl
img_stride	equ	4214h	;* DBG: DBG_CHUNK_BASE + offset img_stride_lbl
render_fn_ptr	equ	4216h	;* DBG: DBG_CHUNK_BASE + offset render_fn_ptr_lbl
saved_di	equ	4218h	;* DBG: DBG_CHUNK_BASE + offset saved_di_lbl
saved_es	equ	421Ah	;* DBG: DBG_CHUNK_BASE + offset saved_es_lbl
...
; ----------------------------------------------------------------------
plane_enable_flags	equ	4213h	;* DBG: DBG_CHUNK_BASE + offset plane_enable_flags_lbl
