...
sub_35		proc	near
		...
		inc	byte ptr ds:data_169e
		cmp	byte ptr ds:data_116e,4
...
locloop_199:
		lodsb				; String [si] to al
		or	al,al			; Zero ?
		jnz	loc_200			; Jump if not zero
		loop	locloop_199		; Loop if cx > 0

loc_200:
		add	al,30h			; '0'
		stosb				; Store al to es:[di]
		jcxz	loc_202			; Jump if cx=0
		dec	cx
