...
cga_blit_fn_a	equ	DBG_CHUNK_BASE + offset cga_blit_fn_a_lbl		;* CGA inner blit loop A (mode 0)
cga_blit_fn_b	equ	DBG_CHUNK_BASE + offset disp_blit_expand		;* CGA inner blit loop B (with mode flag)
cga_blit_fn_c	equ	DBG_CHUNK_BASE + offset disp_blit_clear		;* CGA inner blit loop C (reverse)
cga_mask_tbl_a	equ	32C4h	;* DBG: DBG_CHUNK_BASE + offset cga_mask_tbl_a_lbl
cga_mask_tbl_b	equ	32D4h	;* DBG: DBG_CHUNK_BASE + offset cga_mask_tbl_b_lbl
sprite_src_tbl	equ	3635h	;* DBG: DBG_CHUNK_BASE + offset sprite_src_tbl_lbl
sprite_frame_tbl	equ	3637h	;* DBG: DBG_CHUNK_BASE + offset sprite_frame_tbl_lbl
cga_scroll_mask_off	equ	3945h			;* CS offset of scroll cell mask data
move_seq_up	equ	3A05h			;* DBG: DBG_CHUNK_BASE + offset move_seq_up_lbl
move_seq_horiz	equ	3AC9h			;*
color_pair_tbl	equ	3AFCh	;* DBG: DBG_CHUNK_BASE + offset color_pair_tbl_lbl
cga_palette_xlat	equ	4A97h	;* DBG: DBG_CHUNK_BASE + offset cga_palette_xlat_lbl
cga_color_lut	equ	4AA0h	;* DBG: DBG_CHUNK_BASE + offset cga_color_lut_lbl
cur_col_ctr	equ	4AAAh	;* DBG: DBG_CHUNK_BASE + offset cur_col_ctr_lbl
cur_row_ctr	equ	4AABh	;* DBG: DBG_CHUNK_BASE + offset cur_row_ctr_lbl
cur_pass_ctr	equ	4AACh	;* DBG: DBG_CHUNK_BASE + offset cur_pass_ctr_lbl
render_fn_ptr	equ	4AAEh	;* DBG: DBG_CHUNK_BASE + offset render_fn_ptr_lbl
saved_di	equ	4AB0h	;* DBG: DBG_CHUNK_BASE + offset saved_di_lbl
saved_es	equ	4AB2h	;* DBG: DBG_CHUNK_BASE + offset saved_es_lbl
...
; ----------------------------------------------------------------------
src_word_a	equ	4AA2h	;* DBG: DBG_CHUNK_BASE + offset src_word_a_lbl
src_word_b	equ	4AA4h	;* DBG: DBG_CHUNK_BASE + offset src_word_b_lbl
src_word_c	equ	4AA6h	;* DBG: DBG_CHUNK_BASE + offset src_word_c_lbl
src_word_d	equ	4AA8h	;* DBG: DBG_CHUNK_BASE + offset src_word_d_lbl
render_mode_flag	equ	4AADh	;* DBG: DBG_CHUNK_BASE + offset render_mode_flag_lbl
