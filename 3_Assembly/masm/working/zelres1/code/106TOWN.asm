...
DBG_CHUNK_BASE		EQU	5FFCh		; runtime base = load_addr - 4
...
; ----------------------------------------------------------------------
save_draw_fn	equ	6014h			;* DBG: DBG_CHUNK_BASE + offset save_draw_fn_lbl
save_scroll_up_fn	equ	6018h			;* DBG: DBG_CHUNK_BASE + offset save_scroll_up_fn_lbl
save_scroll_dn_fn	equ	601Ah			;* DBG: DBG_CHUNK_BASE + offset init_entry
...
npc_walk_left	equ	DBG_CHUNK_BASE + offset npc_walk_left_lbl	;*
gseg_chunk_ptr	equ	6AEBh			;* DBG: DBG_CHUNK_BASE + offset gseg_chunk_ptr_lbl
icon_data_a	equ	DBG_CHUNK_BASE + offset town_hud_labels	;* = 6C93h
...
npc_dispatch_tbl	equ	6B41h			;* DBG: DBG_CHUNK_BASE + offset npc_dispatch_tbl_lbl
icon_data_b	equ	DBG_CHUNK_BASE + offset icon_data_b_lbl	;* = 6C9Bh
icon_data_c	equ	DBG_CHUNK_BASE + offset icon_data_c_lbl	;* = 6CA4h
icon_data_d	equ	DBG_CHUNK_BASE + offset icon_data_d_lbl	;* = 6CACh
sar_chunk_tbl	equ	DBG_CHUNK_BASE + offset sar_chunk_tbl_lbl	;*
scene_map_data	equ	DBG_CHUNK_BASE + offset scene_map_data_lbl	;*
save_default_name	equ	DBG_CHUNK_BASE + offset save_default_name_lbl	;*
char_width_tbl	equ	7B82h			;* DBG: DBG_CHUNK_BASE + offset char_width_tbl_lbl
char_glyph_tbl	equ	7BE2h			;* DBG: DBG_CHUNK_BASE + offset char_glyph_tbl_lbl
town_map_side	equ	7C45h			;* DBG: DBG_CHUNK_BASE + offset town_map_side_lbl
town_npc_fn_ptr	equ	7C47h			;* DBG: DBG_CHUNK_BASE + offset town_npc_fn_ptr_lbl
town_npc_col	equ	7C49h			;* DBG: DBG_CHUNK_BASE + offset town_npc_col_lbl
text_draw_x	equ	7C4Eh			;* DBG: DBG_CHUNK_BASE + offset text_draw_x_lbl
text_draw_x2	equ	7C50h			;* DBG: DBG_CHUNK_BASE + offset text_draw_x2_lbl
text_line_ctr	equ	7C52h			;* DBG: DBG_CHUNK_BASE + offset text_line_ctr_lbl
text_box_cols	equ	7C54h			;* DBG: DBG_CHUNK_BASE + offset text_box_cols_lbl
text_str_ptr	equ	7C58h			;* DBG: DBG_CHUNK_BASE + offset text_str_ptr_lbl
text_layout_cx	equ	7C5Ah			;* DBG: DBG_CHUNK_BASE + offset text_layout_cx_lbl
save_name_len	equ	7C5Eh			;* DBG: DBG_CHUNK_BASE + offset save_name_len_lbl
save_name_maxlen	equ	7C5Fh			;* DBG: DBG_CHUNK_BASE + offset save_name_maxlen_lbl
save_cursor_x	equ	7C60h			;* DBG: DBG_CHUNK_BASE + offset save_cursor_x_lbl
save_cursor_y	equ	7C62h			;* DBG: DBG_CHUNK_BASE + offset save_cursor_y_lbl
save_name_buf	equ	7C67h			;* DBG: DBG_CHUNK_BASE + offset save_name_buf_lbl
save_name_end	equ	7C6Eh			;* DBG: DBG_CHUNK_BASE + offset save_name_end_lbl
npc_anim_buf	equ	DBG_CHUNK_BASE + offset npc_anim_buf_lbl	;* = 7C74h
npc_col_buf	equ	DBG_CHUNK_BASE + offset npc_col_buf_lbl	;* = 7C7Ah
...
music_fn_ptr	equ	6AE9h			;* DBG: DBG_CHUNK_BASE + offset music_fn_ptr_lbl
game_exit_fn	equ	7686h			;* DBG: DBG_CHUNK_BASE + offset game_exit_fn_lbl

; ----------------------------------------------------------------------
; Section 6: File-internal state variables
; ----------------------------------------------------------------------
screen_pos_481C	equ	481Ch			;*
town_scene_flag	equ	7C42h			;* DBG: DBG_CHUNK_BASE + offset town_scene_flag_lbl
town_init_flag	equ	7C43h			;* DBG: DBG_CHUNK_BASE + offset town_init_flag_lbl
town_load_flag	equ	7C44h			;* DBG: DBG_CHUNK_BASE + offset town_load_flag_lbl
town_palette_idx	equ	7C46h			;* DBG: DBG_CHUNK_BASE + offset town_palette_idx_lbl
town_exit_flag	equ	7C4Bh			;* DBG: DBG_CHUNK_BASE + offset town_exit_flag_lbl
town_char_idx	equ	7C4Ch			;* DBG: DBG_CHUNK_BASE + offset town_char_idx_lbl
text_col_pos	equ	7C53h			;* DBG: DBG_CHUNK_BASE + offset text_col_pos_lbl
text_box_flag	equ	7C55h			;* DBG: DBG_CHUNK_BASE + offset text_box_flag_lbl
text_anim_step	equ	7C56h			;* DBG: DBG_CHUNK_BASE + offset text_anim_step_lbl
text_row_flag	equ	7C57h			;* DBG: DBG_CHUNK_BASE + offset text_row_flag_lbl
text_done_flag	equ	7C5Ch			;* DBG: DBG_CHUNK_BASE + offset text_done_flag_lbl
text_wrap_flag	equ	7C5Dh			;* DBG: DBG_CHUNK_BASE + offset text_wrap_flag_lbl
save_del_flag	equ	7C63h			;* DBG: DBG_CHUNK_BASE + offset save_del_flag_lbl
save_new_flag	equ	7C64h			;* DBG: DBG_CHUNK_BASE + offset save_new_flag_lbl
...
hw_probe_pushds_byte		db	1Eh				; PUSH DS (hardware probe byte)
		...
		db	'uDs9u'				; probe data bytes 0x13-0x17
save_draw_fn_lbl:
		db	'it'				; probe data bytes 0x18-0x19 (save_draw_fn slot)
		db	'Bp'				; probe data bytes 0x1A-0x1B
save_scroll_up_fn_lbl:
		db	'{t'				; probe data bytes 0x1C-0x1D (save_scroll_up_fn slot)

init_entry:
		cmpsw				; Cmp [si] to es:[di]
		db	74h, 92h		; jz $-6Ch (MASM evaluates $-constant differently from TASM; use raw bytes)
...
player_load_chunk		endp
		...
		db	'CKPD.BIN', 0
music_fn_ptr_lbl:
		db	0				; table separator (music_fn_ptr slot)
		db	'3'				; SAR table entry byte
gseg_chunk_ptr_lbl:
		db	0				; table terminator (gseg_chunk_ptr slot)
...
enter_savegame_dialog		endp
		...
		db	'GAME.BIN', 0
game_exit_fn_lbl:
		db	0				; 2nd null of GAME.BIN entry (game_exit_fn slot)
...
char_width_tbl_lbl:
		...
		db	1, 0			; row 15 (first 2 bytes)
char_glyph_tbl_lbl:
		db	5, 4, 4, 4		; row 15 (last 4 bytes; char_glyph_tbl slot)
		...
		db	7, 8			; row 31 (first 2 bytes)
town_scene_flag_lbl:
		db	0			; row 31 last byte / town_scene_flag (7C42)
; --- State variable block (58 bytes, zero-initialized) ---
town_init_flag_lbl:
		db	0			; +0  7C43 town_init_flag
town_load_flag_lbl:
		db	0			; +1  7C44 town_load_flag
town_map_side_lbl:
		db	0			; +2  7C45 town_map_side
town_palette_idx_lbl:
		db	0			; +3  7C46 town_palette_idx
town_npc_fn_ptr_lbl:
		db	0, 0			; +4  7C47 town_npc_fn_ptr (word)
town_npc_col_lbl:
		db	0, 0			; +6  7C49 town_npc_col (word)
town_exit_flag_lbl:
		db	0			; +8  7C4B town_exit_flag
town_char_idx_lbl:
		db	0			; +9  7C4C town_char_idx
		db	0			; +10 7C4D (gap)
text_draw_x_lbl:
		db	0, 0			; +11 7C4E text_draw_x (word)
text_draw_x2_lbl:
		db	0, 0			; +13 7C50 text_draw_x2 (word)
text_line_ctr_lbl:
		db	0			; +15 7C52 text_line_ctr
text_col_pos_lbl:
		db	0			; +16 7C53 text_col_pos
text_box_cols_lbl:
		db	0			; +17 7C54 text_box_cols
text_box_flag_lbl:
		db	0			; +18 7C55 text_box_flag
text_anim_step_lbl:
		db	0			; +19 7C56 text_anim_step
text_row_flag_lbl:
		db	0			; +20 7C57 text_row_flag
text_str_ptr_lbl:
		db	0, 0			; +21 7C58 text_str_ptr (word)
text_layout_cx_lbl:
		db	0, 0			; +23 7C5A text_layout_cx (word)
text_done_flag_lbl:
		db	0			; +25 7C5C text_done_flag
text_wrap_flag_lbl:
		db	0			; +26 7C5D text_wrap_flag
save_name_len_lbl:
		db	0			; +27 7C5E save_name_len
save_name_maxlen_lbl:
		db	0			; +28 7C5F save_name_maxlen
save_cursor_x_lbl:
		db	0, 0			; +29 7C60 save_cursor_x (word)
save_cursor_y_lbl:
		db	0			; +31 7C62 save_cursor_y
save_del_flag_lbl:
		db	0			; +32 7C63 save_del_flag
save_new_flag_lbl:
		db	0			; +33 7C64 save_new_flag
		db	0, 0			; +34 7C65 (gap)
save_name_buf_lbl:
		db	7 dup (0)		; +36 7C67 save_name_buf (7 bytes)
save_name_end_lbl:
		db	6 dup (0)		; +43 7C6E save_name_end (6 bytes)
npc_anim_buf_lbl:
		db	6 dup (0)		; +49 7C74 npc_anim_buf (6 bytes)
npc_col_buf_lbl:
		db	3 dup (0)		; +55 7C7A npc_col_buf (3 bytes)
