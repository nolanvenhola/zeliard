...
shop_subtitle_tbl	equ	DBG_CHUNK_BASE + offset shop_subtitle_tbl_lbl		;* item subtitle/text lookup @ 0x494
banner_glyph_tbl	equ	DBG_CHUNK_BASE + offset banner_glyph_tbl_lbl		;* shop banner glyph-code table @ 0x5E4
shop_entry_init		equ	0A644h		;* shop entry-byte (module header byte) @ 0x644
price_gfx_tbl	equ	DBG_CHUNK_BASE + offset price_gfx_tbl_lbl		;* item price/stat glyph table @ 0x69C
greet_str_tbl	equ	DBG_CHUNK_BASE + offset greet_str_tbl_lbl		;* greeting string table (word array) @ 0x745
...
item_data_records	equ	DBG_CHUNK_BASE + offset drugp_item_data_records		;* item data records (9 items ?? 24 bytes)
