...
loc_8:
		...
		jnz	loc_10			; Jump if not zero
		test	byte ptr ds:data_65e,0FFh
...
sub_1		proc	near
		...
		or	al,0A0h
		popf				; Pop flags
		add	ss:data_48e[bp+di],bh
		call	word ptr cs:data_34e
		call	word ptr cs:data_32e
loc_17:
		int	61h			; ??INT Non-standard interrupt
		and	al,0Ch
...
loc_42:
		...
		jmp	loc_11
loc_43:
		test	byte ptr ds:data_75e,0FFh
...
loc_51:
		cmp	byte ptr ds:data_84e,78h	; 'x'
...
sub_9		proc	near
		...
		retn
loc_54:
		mov	byte ptr ds:data_75e,0FFh
		mov	ax,643h
		xor	di,di			; Zero register
		mov	cx,1C24h
		jmp	word ptr cs:data_37e
sub_9		endp
...
locloop_62:
		...
		add	ds:data_79e[bx+di],dh
;*		add	cx,bp
		db	 01h,0E9h		;  Fixup - byte match
;*		jmp	far ptr loc_83		;*
		db	0EAh
		dw	0C02h, 5CBBh		;  Fixup - byte match
		db	 00h,0B1h, 43h,0BEh, 92h,0AAh
		db	0B4h, 01h,0E9h,0DCh, 02h
		db	0Ch
