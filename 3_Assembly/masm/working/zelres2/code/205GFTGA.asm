...
dispatch_tbl	equ	3172h	;* DBG: DBG_CHUNK_BASE + offset dispatch_tbl_lbl
pattern_ptr_tbl	equ	39E8h	;* DBG: DBG_CHUNK_BASE + offset pattern_ptr_tbl_lbl
color_map_tbl	equ	4264h	;* DBG: DBG_CHUNK_BASE + offset color_map_tbl_lbl
bg_tile_src	equ	DBG_CHUNK_BASE + offset gf_tga_phase_idx_tbl		;*
copy_fn_tbl	equ	489Dh	;* DBG: DBG_CHUNK_BASE + offset copy_fn_tbl_lbl
hero_gfx_tbl	equ	4BFBh	;* DBG: DBG_CHUNK_BASE + offset hero_gfx_tbl_lbl
color_pair_tbl	equ	51D2h	;* DBG: DBG_CHUNK_BASE + offset color_pair_tbl_lbl
cur_color_pair	equ	522Fh	;* DBG: DBG_CHUNK_BASE + offset cur_color_pair_lbl
vga_row_ptr	equ	5231h	;* DBG: DBG_CHUNK_BASE + offset vga_row_ptr_lbl
scroll_vga_ofs	equ	5233h	;* DBG: DBG_CHUNK_BASE + offset scroll_vga_ofs_lbl
scroll_src_ofs	equ	5235h	;* DBG: DBG_CHUNK_BASE + offset scroll_src_ofs_lbl
scroll_gfx_ptr	equ	523Dh	;* DBG: DBG_CHUNK_BASE + offset scroll_gfx_ptr_lbl
scroll_delta	equ	523Fh	;* DBG: DBG_CHUNK_BASE + offset scroll_delta_lbl
shift_count	equ	5244h	;* DBG: DBG_CHUNK_BASE + offset shift_count_lbl
sprite_row_buf	equ	5245h			;*
sprite_pos	equ	5259h			;*
sprite_cache_tbl	equ	5262h	;* DBG: DBG_CHUNK_BASE + offset sprite_cache_tbl_lbl
save_background_pixels_buf	equ	5362h			;*
...
; ----------------------------------------------------------------------
row_counter	equ	5237h	;* DBG: DBG_CHUNK_BASE + offset row_counter_lbl
col_idx	equ	5238h	;* DBG: DBG_CHUNK_BASE + offset col_idx_lbl
row_idx	equ	5239h	;* DBG: DBG_CHUNK_BASE + offset row_idx_lbl
palette_byte	equ	523Ah	;* DBG: DBG_CHUNK_BASE + offset palette_byte_lbl
bitmask_word	equ	523Bh	;* DBG: DBG_CHUNK_BASE + offset bitmask_word_lbl
mask_word	equ	5241h	;* DBG: DBG_CHUNK_BASE + offset mask_word_lbl
sprite_state_a	equ	5255h	;* DBG: DBG_CHUNK_BASE + offset sprite_state_a_lbl
sprite_state_b	equ	5256h	;* DBG: DBG_CHUNK_BASE + offset sprite_state_b_lbl

; ----------------------------------------------------------------------
; Section 7: Constants
; ----------------------------------------------------------------------
anim_frame_tbl	equ	DBG_CHUNK_BASE + offset anim_frame_tbl_lbl		;*
anim_phase	equ	5243h	;* DBG: DBG_CHUNK_BASE + offset anim_phase_lbl
...
; Current target: 0050h + 16ADh = 16FDh (wrap_scroll_si_high).
		db	0E8h				; call near opcode
tga_row_ofs	db	0ADh,16h			; displacement (patch target); initially calls 16FDh (wrap_scroll_si_high)
...
loc_6:
		...
		SPRITE_SLOT_SCAN_STEP loc_10
		SPRITE_SLOT_SCAN_STEP loc_11
		test	byte ptr [si],80h
...
col_scan_loop:
				...
				SPRITE_STATE_SCAN_STEP loc_22
				SPRITE_STATE_SCAN_STEP loc_23
				lodsb				; String [si] to al
				inc	di
				or	al,al			; Zero ?
...
; below (render_frame_rows -> scroll_blit_dispatch chain).
...
loc_182:
		...
		push	si
		push	bx
		call	restore_background_pixels_impl
		pop	bx
		pop	si
		pop	di
		pop	es
...
save_background_pixels		proc	near
		...
		mov	ax,0B800h
		mov	ds,ax
		mov	di,save_background_pixels_buf
		mov	cx,20h
...
restore_background_pixels_impl		proc	near
		mov	di,cs:[scroll_gfx_ptr]
		mov	ax,0B800h
		mov	es,ax
		mov	si,save_background_pixels_buf
		mov	cx,20h
...
restore_background_pixels_impl		endp
...
; game_seg:tga_buf_8cf0 (the 8CF0h buffer), selecting source by ds:[selected_spell].
...
;--------------------------------------------------------------------------
; Sprite/animation lookup tables (chunk_05 file offsets 0x1A42..0x1AFB;
; 186 bytes).  Earlier "Character encoding / font lookup table" + "tile
; pair lookup" interleaved blocks here were Sourcer-mis-decoded from data
; — they emitted ~66 bytes of bogus output instead of the original 186.
; Restored verbatim from chunk_05.bin extracted bytes.
;--------------------------------------------------------------------------
		db	000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h, 069h, 071h, 073h	; 0x1A42
		db	074h, 01Fh, 020h, 02Ch, 027h, 01Fh, 020h, 017h, 018h, 038h, 03Ah, 03Fh	; 0x1A4E
		db	042h, 045h, 000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h	; 0x1A5A
		db	000h, 000h, 06Dh, 075h, 077h, 079h, 06Fh, 02Bh, 026h, 029h, 026h, 01Ah	; 0x1A66
		db	034h, 039h, 03Bh, 040h, 041h, 000h, 000h, 000h, 000h, 000h, 000h, 000h	; 0x1A72
		db	000h, 000h, 000h, 000h, 000h, 000h, 000h, 076h, 078h, 07Ah, 07Bh, 031h	; 0x1A7E
		db	032h, 02Fh, 02Dh, 033h, 036h, 037h, 03Ch, 000h, 000h, 000h, 000h, 000h	; 0x1A8A
		db	000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h	; 0x1A96
		db	000h, 000h, 06Dh, 071h, 070h, 072h, 070h, 000h, 000h, 000h, 000h, 000h	; 0x1AA2
		db	000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h	; 0x1AAE
		db	000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h	; 0x1ABA
		db	000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h	; 0x1AC6
		db	000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h	; 0x1AD2
		db	000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h	; 0x1ADE
		db	000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h	; 0x1AEA
		db	000h, 000h, 000h, 000h, 000h, 000h	; 0x1AF6
; Tile pair entries continuation (chunk_05 0x1AFC..0x1B50)
		db	000h, 001h, 002h, 001h, 002h, 001h, 002h, 001h, 002h, 001h, 002h, 001h	; 0x1AFC
		db	002h, 001h, 002h, 001h, 002h, 001h, 002h, 001h, 002h, 001h, 002h, 001h	; 0x1B08
		db	002h, 001h, 002h, 001h, 002h, 003h, 004h, 003h, 004h, 003h, 004h, 003h	; 0x1B14
		db	004h, 003h, 004h, 003h, 004h, 003h, 004h, 003h, 004h, 003h, 004h, 003h	; 0x1B20
		db	004h, 003h, 004h, 003h, 004h, 003h, 004h, 003h, 004h, 005h, 006h, 005h	; 0x1B2C
		db	006h, 005h, 006h, 005h, 006h, 005h, 006h, 005h, 006h, 005h, 006h, 005h	; 0x1B38
		db	006h, 005h, 006h, 005h, 006h, 005h, 006h, 006h, 005h, 005h, 006h, 005h	; 0x1B44
		db	006h	; 0x1B50
...
rotate_plane_pair_tga		proc	near
		mov	cx,4
