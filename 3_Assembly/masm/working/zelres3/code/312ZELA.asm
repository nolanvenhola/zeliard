...
zela_unk_tbl_a	equ	DBG_CHUNK_BASE + offset zela_unk_tbl_a_lbl		; unknown table A (referenced by header)
zela_unk_tbl_b		equ	0A343h		; unknown table B
zela_unk_tbl_c	equ	DBG_CHUNK_BASE + offset scroll_phase_dispatch		; unknown table C
