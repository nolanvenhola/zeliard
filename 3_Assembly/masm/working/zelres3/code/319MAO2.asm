...
mao2_handler_step_tbl	equ	DBG_CHUNK_BASE + offset mao2_handler_step_tbl_lbl		; phase-handler 3-byte step table base
mao2_dlg_state_word_a	equ	0A8A9h			; dialog-state word in trailer data region
mao2_dialog_di_tbl_a	equ	DBG_CHUNK_BASE + offset mao2_dialog_di_tbl_a_lbl		; DI per-dialog phase table (alt set A)
mao2_dlg_state_word_b	equ	DBG_CHUNK_BASE + offset mao2_dlg_state_word_b_lbl		; dialog-state byte in trailer data region
mao2_dlg_state_word_c	equ	0A9DBh			; dialog-state byte in trailer data region
mao2_dialog_bp_tbl_a	equ	DBG_CHUNK_BASE + offset mao2_dialog_bp_tbl_a_lbl		; BP per-dialog phase table (alt set A)
mao2_phase_handler_tbl	equ	DBG_CHUNK_BASE + offset mao2_phase_handler_tbl_lbl		; secondary phase handler ptr table
