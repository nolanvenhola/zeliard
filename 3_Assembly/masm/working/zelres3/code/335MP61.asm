...
seg_a		segment	byte public
		...
		db	0ECh, 18h, 00h
data_2		db	0
		db	 25h,0D5h, 00h, 01h, 81h,0D3h
		db	0A1h,0D3h,0A3h,0D3h, 1Ch,0D4h
		db	0D2h,0D4h, 12h,0D5h, 2Ah,0D5h
		db	 06h,0FFh,0FFh,0FFh, 0Ah, 00h
		db	 00h, 81h,0D3h, 63h, 01h, 1Dh
		db	 53h, 48h,0C8h,0C9h, 49h,0CBh
		db	 83h,0C3h, 05h, 04h, 91h,0C3h
		db	 09h, 04h,0E0h, 82h, 06h, 04h
		db	 07h, 04h,0C7h,0C9h,0C8h,0C4h
		db	0C7h,0C9h, 49h,0CBh, 82h,0C3h
		db	 05h, 04h, 91h,0C3h, 0Ah, 04h
		db	 82h, 06h, 04h,0C4h, 01h, 20h
		db	 05h, 04h,0C7h,0C4h,0C7h, 58h
		db	0CAh,0C8h,0E0h, 07h, 04h, 91h
		db	0C3h, 0Ah, 04h,0E0h, 43h,0E0h
		db	 73h, 88h,0C3h, 46h, 68h,0C8h
		db	 09h, 04h, 91h,0C3h,0C4h, 87h
		db	0C3h, 43h, 89h,0C2h, 40h, 41h
		db	 40h, 81h,0C3h,0CDh,0C7h, 48h
		db	0C8h, 0Bh, 04h, 40h, 51h, 50h
		db	 41h, 87h,0C3h,0C4h, 40h, 51h
		db	0C1h, 81h,0C3h, 43h,0C2h,0C1h
		db	 41h, 40h,0C2h, 40h, 88h,0C3h
		db	0D8h,0CDh,0C9h,0C8h, 73h,0DDh
		db	 06h, 04h, 91h,0C3h,0C4h, 87h
		db	0C3h, 43h, 89h, 63h, 86h,0D8h
		db	0CDh,0C8h, 05h, 04h, 85h,0C3h
		db	0C4h, 85h,0C3h, 07h, 04h, 83h
		db	0C3h,0C4h, 8Fh,0C3h, 43h,0E0h
		db	 63h, 87h,0D8h,0CDh, 05h, 04h
		db	 85h,0C3h,0C4h, 85h,0C3h,0C4h
		db	0DDh, 05h, 04h, 83h,0C3h,0C4h
		db	 8Fh,0C3h, 53h, 63h, 88h,0D8h
		db	0C4h
...
loc_3:
		...
		test	ax,bx
		push	bx
		mov	ds:data_13e[bx+di],cl
		les	ax,dword ptr ds:data_7e[si]	; Load seg:offset ptr
		test	ax,bx
		inc	bx
		test	ax,bx
		les	ax,dword ptr ds:data_10e[di]	; Load seg:offset ptr
		retn
