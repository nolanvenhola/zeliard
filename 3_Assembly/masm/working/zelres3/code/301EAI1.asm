...
crab_rotate_a	equ	DBG_CHUNK_BASE + offset crab_rotate_a_lbl		; crab rotation/swap pattern table
crab_rotate_b	equ	DBG_CHUNK_BASE + offset crab_rotate_b_lbl		; crab rotation/swap pattern table B
