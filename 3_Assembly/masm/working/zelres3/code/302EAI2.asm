...
eai2_bc_string_anchor		db	'BC', 0			; (Sourcer's eai2_bc_string_anchor) -- referenced as `cs:eai2_bc_string_anchor+4`
		db	'D'
tako_facing_fn_lbl	label	near			; = eai2_bc_string_anchor+4: pseudo-fn entry point
		db	'EFG', 0
		db	'HIJK', 0
		db	'DELM', 0
		db	'DEFN', 0
...
set_swim_targets:
		call	word ptr cs:tako_facing_fn_lbl	; (eai2_bc_string_anchor+4 -- inline pseudo-fn, returns AL with sign for facing)
		and	al,3
		dec	al
		add	al,8
