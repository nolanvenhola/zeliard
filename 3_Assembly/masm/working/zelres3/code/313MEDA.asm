...
; ----------------------------------------------------------------------
meda_tile_src_a	equ	DBG_CHUNK_BASE + offset meda_tile_src_a_data		; tile source base A (passed to render_tiles)
meda_tile_src_b	equ	DBG_CHUNK_BASE + offset meda_tile_src_b_data		; tile mask base B
meda_tile_src_c	equ	DBG_CHUNK_BASE + offset meda_tile_src_c_data		; tile source base C
meda_tile_src_d	equ	DBG_CHUNK_BASE + offset meda_tile_src_d_data		; tile mask base D
meda_tile_src_e_tbl	equ	0A62Eh		; tile source E (indexed table)
meda_tile_src_f	equ	DBG_CHUNK_BASE + offset meda_tile_src_f_data		; tile mask F
