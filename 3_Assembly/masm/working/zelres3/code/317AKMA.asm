...
; ----------------------------------------------------------------------
akma_phase_si_tbl_a	equ	DBG_CHUNK_BASE + offset akma_phase_si_tbl_a_lbl		; SI per-phase tbl A (phase-A render path)
akma_phase_di_tbl_a	equ	DBG_CHUNK_BASE + offset akma_phase_si_word_tbl		; DI per-phase tbl A
akma_phase_si_tbl_b	equ	DBG_CHUNK_BASE + offset akma_xlat_tbl_a969_data		; SI per-phase tbl B (active-mode swap)
akma_phase_si_tbl_c	equ	DBG_CHUNK_BASE + offset akma_pattern_string_a		; SI per-phase tbl C (mid-stage)
