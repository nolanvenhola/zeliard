...
lega_tbl_a41b	equ	DBG_CHUNK_BASE + offset lega_tbl_a41b_lbl		; xlat table base (mov bx, 0A41Bh + xlat)
lega_anim_dx_tbl	equ	0A5D8h		; per-phase delta-X table base
lega_anim_dy_tbl	equ	0A5D9h		; per-phase delta-Y table base
lega_phase_xlat_a	equ	DBG_CHUNK_BASE + offset lega_phase_xlat_a_lbl		; phase-A xlat table (xlat-indexed)
lega_phase_xlat_b	equ	DBG_CHUNK_BASE + offset lega_phase_xlat_b_lbl		; phase-B xlat table (xlat-indexed)
lega_dispatch_tbl	equ	DBG_CHUNK_BASE + offset lega_dispatch_tbl_b		; trailer dispatch jump-table base
...
lega_unk_a6c8	equ	DBG_CHUNK_BASE + offset lega_dispatch_tbl_data		; (unresolved table ref)
