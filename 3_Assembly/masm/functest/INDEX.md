...
| proc_equivalence | [test_sword_knight_oracle.py](proc_equivalence/test_sword_knight_oracle.py) | Release `212ARMRP.bin`/`201SELCT.bin`/`200FIGHT.bin` Knight's Sword contract - Tumba/Glory-Crest/one-time gates, Yes/No exchange text, atomic crest consumption/equip/stock mutation, tier-4 asset load, exact HUD text, attack audio edge, and native base power 8 |
