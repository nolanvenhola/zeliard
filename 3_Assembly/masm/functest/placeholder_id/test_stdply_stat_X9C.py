...
CHUNK     = 'fight'
ENTITY_FN_E_4 = 0x9083    # current rebuilt 200FIGHT.bin entry
ENTITY_TRIGGER_SCAN = 0x90D7
...
def main() -> int:
    ...
    # Stub entity_trigger_scan to return CF=0 so the entity_fn_e_4 path takes
    ...
    result = h.call_function(
        ...
        stub_calls={ENTITY_TRIGGER_SCAN: {'cf': 0, 'ax': 0}},
        watch_reads=[0x9C],
        watch_writes=[0x9C],
        max_steps=200,
    )
