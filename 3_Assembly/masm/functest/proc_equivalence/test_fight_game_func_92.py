...
def main() -> int:
    ...
    prep_dirty_blit = base + resolve_proc('fight', 'prep_dirty_blit',
                                          fallback_names=('game_func_92',))
    calc_hud_buf_offset = base + resolve_proc('fight', 'calc_hud_buf_offset')
    scroll_buf_offset = base + resolve_proc('fight', 'scroll_buf_offset',
    ...
    snap = h.snapshot()
    r = h.call_function(prep_dirty_blit, regs={'si': SI},
    ...
    h.write_byte(0x82, 0)
    snap = h.snapshot()
    r = h.call_function(prep_dirty_blit, regs={'si': SI, 'di': SI},
                        stub_calls={calc_hud_buf_offset: {}, scroll_buf_offset: {}},
                        max_steps=100)
