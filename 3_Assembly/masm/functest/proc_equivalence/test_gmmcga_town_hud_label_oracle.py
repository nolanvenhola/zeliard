#!/usr/bin/env python3
"""Release-MASM oracle for GMMCGA:22BF town HUD label records."""
...
ENTRY, RET_SENTINEL = 0x22BF, 0x0080
EXPECTED_VGA_FNV = 0x887B657AB4281BB6
EXPECTED_STATE_FNV = 0x08876C07B5338058
...
def main() -> int:
    ...
    record = bytes((0x0E, 0xA3, 0x00, 0x04)) + b"LIFE"
