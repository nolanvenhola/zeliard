...
CHUNK         = 'fight'
START_BOSS_SCROLL = 0x9053   # file offset 0x3053 + load_base 0x6000
GAME_MULTIPLY     = 0x7413   # game_multiply proc near (called by start_boss_scroll)
...
def main() -> int:
    ...
    # game_multiply will be called by start_boss_scroll.  Stub it as a
    # near-call no-op so we don't follow into multiplication code.
    result = h.call_function(
        START_BOSS_SCROLL,
        regs={'si': SI_BASE, 'ax': 0, 'bx': 0},
        stub_calls={GAME_MULTIPLY: {}},   # near-call to game_multiply_X stubs as RET
