...
CHUNK = 'fight'
GAME_FUNC_120 = 0x9183


def probe(h, almas_initial, ax_in):
    h.write_word(0x8B, almas_initial)
    snap = h.snapshot()
    result = h.call_function(GAME_FUNC_120, regs={'ax': ax_in},
                             max_steps=200)
...
def main() -> int:
    ...
    print(f'game_func_120 @ CPU 0x{GAME_FUNC_120:04X}')
