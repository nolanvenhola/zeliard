...
FIELDS = [
    ...
    ('cur_weapon_idx',       0x9D, 'b',  'Currently selected weapon index (matches inventory cursor)'),
    ('cur_magic_idx',        0x9E, 'b',  'Currently selected magic spell index'),
    ('music_track_count',    0xA0, 'b',  'Possibly "highest weapon tier reached" (correlates with cur_weapon_idx+1, NOT music count per save data)'),
    ('spell_slot_1',         0xA1, 'b',  'Spell inventory slot 1 (0=empty; otherwise spell ID 1..7)'),
    ('spell_slot_2',         0xA2, 'b',  'Spell inventory slot 2'),
    ('spell_slot_3',         0xA3, 'b',  'Spell inventory slot 3'),
    ('spell_slot_4',         0xA4, 'b',  'Spell inventory slot 4'),
    ('spell_slot_5',         0xA5, 'b',  'Spell inventory slot 5'),
    ('item_slot_1',          0xA6, 'b',  'Item inventory slot 1 (0=empty; otherwise item ID 1..8: 1=Kenko 2=Juuen 3=Elixir 4=Chikara 5=Magia 6=HolyWater 7=SabreOil 8=KiokuFeather)'),
    ('item_slot_2',          0xA7, 'b',  'Item inventory slot 2'),
    ('item_slot_3',          0xA8, 'b',  'Item inventory slot 3'),
    ('item_slot_4',          0xA9, 'b',  'Item inventory slot 4'),
    ('item_slot_5',          0xAA, 'b',  'Item inventory slot 5'),
