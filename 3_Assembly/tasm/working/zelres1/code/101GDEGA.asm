...
ega_setup_mode2_a:
		...
		db	0C7h, 06h, 16h, 42h, 71h, 30h	; mov word[render_fn_ptr],3071h
...
ega_setup_mode1:
		...
		out	dx,ax			; port 3CEh, EGA graphic index
						;  al = 5, mode
		mov	word ptr cs:render_fn_ptr,30C5h
		pop	ax
...
ega_setup_mode2:
		...
		out	dx,ax			; port 3CEh, EGA graphic index
						;  al = 5, mode
		mov	word ptr cs:render_fn_ptr,3121h
		mov	al,0FFh
		call	imgctl_multiply
		mov	ax,5
		out	dx,ax			; port 3CEh, EGA graphic index
...
ega_setup_mode3:
		...
		out	dx,ax			; port 3CEh, EGA graphic index
						;  al = 5, mode
		mov	word ptr cs:render_fn_ptr,314Dh
