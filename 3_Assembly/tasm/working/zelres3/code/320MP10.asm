...
;==========================================================================
;
;  320MP10 - Map Data Table: Cavern of Malicia, level 1, floor 0 (entrance)
;
;  Cavern/labyrinth map resource file loaded as MP10.MDT (zelres3).
