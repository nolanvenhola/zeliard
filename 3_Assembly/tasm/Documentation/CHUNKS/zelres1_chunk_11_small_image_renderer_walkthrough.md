# ZELRES1/Chunk_11 - Small Image Renderer (32Ã—18) Walkthrough

**File**: `2_SAR/ExtractedChunks/zelres1_extracted/chunk_11.bin`
**Disassembly**: `3_Assembly/tasm/working/zelres1/code/111GTMCA.asm`
**Size**: 5,329 bytes (5.3KB)
**Disassembly Lines**: 2,549 lines
**Purpose**: Renders small 32Ã—18 character images using 4-plane VGA bitplane decoder
**Load Address**: Variable (loaded by chunk_00)
**Priority**: â­�â­�â­� CRITICAL (Opening scene small image renderer)

## Overview

**ZELRES1/Chunk_11** is the small image variant of chunk_10, handling 32-column Ã— 18-row character images (256Ã—144 pixels). It uses the same 4-plane bitplane decoding algorithm but optimized for smaller dimensions and often used for character portraits, text boxes, and UI overlays.

### What This Chunk Does

1. **4-Plane Bitplane Decoding** - Identical to chunk_10 (IRGB planes)
2. **Small Image Layout** - Handles 32Ã—18 character grid (256Ã—144 pixels)
3. **Faster Rendering** - 3Ã— fewer characters than chunk_10
...
**Key Difference from Chunk_10**: Chunk_11 handles smaller images (32Ã—18 vs 48Ã—34) and includes additional centering/overlay support.
...
â”‚   ZELRES1/Chunk_11 - Small Image Renderer (32Ã—18, 4-plane)   â”‚
â”‚                                                                â”‚
...
â”‚  â”‚ - Calculate plane stride (width Ã— height Ã— 8)      â”‚      â”‚
â”‚  â”‚ - Apply centering offset if requested              â”‚      â”‚
â”‚  â””â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”˜      â”‚
â”‚                â†“                                              â”‚
â”‚  Centering and Positioning (0x0020-0x0080)                   â”‚
â”‚  â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”�      â”‚
â”‚  â”‚ - Check centering flag                              â”‚      â”‚
â”‚  â”‚ - Calculate center offset: (40-width)/2             â”‚      â”‚
â”‚  â”‚ - Add to BL (column) for horizontal centering       â”‚      â”‚
â”‚  â”‚ - Vertical centering: (25-height)/2                 â”‚      â”‚
â”‚  â””â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”˜      â”‚
â”‚                â†“                                              â”‚
â”‚  VGA Setup (0x0080-0x0120)                                   â”‚
â”‚  â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”�      â”‚
â”‚  â”‚ [Same as chunk_10]                                  â”‚      â”‚
â”‚  â”‚ - Calculate VGA destination: rowÃ—80 + col           â”‚      â”‚
â”‚  â”‚ - Configure Sequencer and Graphics Controller       â”‚      â”‚
â”‚  â””â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”˜      â”‚
â”‚                â†“                                              â”‚
â”‚  Character Loop (0x0120-0x0280)                              â”‚
â”‚  â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”�      â”‚
â”‚  â”‚ [Same algorithm as chunk_10]                        â”‚      â”‚
â”‚  â”‚ For each character (32Ã—18 = 576 chars):             â”‚      â”‚
â”‚  â”‚   - Read 8 bytes from each of 4 planes             â”‚      â”‚
â”‚  â”‚   - Decode bitplanes into pixels                    â”‚      â”‚
â”‚  â”‚   - Write to VGA with plane masking                 â”‚      â”‚
â”‚  â””â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”˜      â”‚
â”‚                â†“                                              â”‚
â”‚  Transparency Support (0x0280-0x0350)                        â”‚
â”‚  â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”�      â”‚
â”‚  â”‚ - Optional: Check transparency bit in source        â”‚      â”‚
â”‚  â”‚ - If transparent, skip writing pixel                â”‚      â”‚
â”‚  â”‚ - Used for character portraits over backgrounds     â”‚      â”‚
â”‚  â””â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”˜      â”‚
...
## Entry Point with Centering (zr1_11 (0x0000)-0x0080)
...
- **32 characters wide**: 256 pixels (32 Ã— 8)
- **18 characters tall**: 144 pixels (18 Ã— 8)
- **Total**: 576 characters = 4,608 scanlines = 36,864 pixels
- **Bitplane data**: 36,864 pixels Ã· 8 = 4,608 bytes per plane
...
Vertical center: (25-18)/2 = 3.5 â‰ˆ 3 characters from top
...
0x0120:  ; Process all characters
    mov cx,bp                    ; CX = character count (32Ã—18=576)
...
0x0135:  ; Scanline loop
    ...
    ; Decode 8 pixels:
    call decode_scanline         ; â†’ Decode and write
...
0x0290:  ; Pixel loop
    ...
    ; Write pixel:
    call write_vga_pixel         ; â†’ Write DL
...
Example:
  ...
  Overlay:    [0x00, 0x00, 0x09, 0x0A, ...]
              ^transparent â†’ background shows through
...
- Render time: ~24ms @ 4.77 MHz (2.8Ã— faster)
...
|---------|------|---------|
| `plane_stride` | 2 bytes | Bytes per plane (4,608 for 32Ã—18) |
...
mov cx,0x2012                    ; 32Ã—18 characters
...
mov cx,0x2004                    ; 32Ã—4 characters
...
|------------|--------------|---------------|----------|
| Character Portrait | 20Ã—24 | 160Ã—192 | NPC faces |
| Speech Bubble | 16Ã—8 | 128Ã—64 | Dialogue |
| Text Box | 32Ã—4 | 256Ã—32 | Bottom text |
| Small Background | 32Ã—18 | 256Ã—144 | Scenes |
| UI Panel | 24Ã—12 | 192Ã—96 | Menus |
...
- â­� **Small image optimized**: 2.8Ã— faster than chunk_10
- â­� **Centering support**: Automatic horizontal/vertical centering
- â­� **Transparency**: Optional color-keyed transparency for overlays
- â­� **Same algorithm**: Shares 4-plane decoding with chunk_10
- â­� **Versatile**: Handles portraits, UI, text boxes
- â­� **Efficient**: Minimal overhead beyond rendering
...
**Shared Algorithm**:
1. Calculate plane strides (width Ã— height Ã— 8)
2. Setup VGA sequencer and graphics controller
3. For each character (8Ã—8 pixels):
...
**Differences**:
- **Chunk_10**: 48Ã—34 (large), no centering, no transparency
- **Chunk_11**: 32Ã—18 (small), centering support, transparency support
