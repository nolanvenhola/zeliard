...
| `0x0000` | `zr1_07` |
| `0x0002` | `zr1_30` |
| `0x00d9` | `simg_multiply` |
| `0x00df` | `decb_func_2` |
| `0x00e1` | `limg_multiply` |
| `0x00e4` | `vgadec_multiply` |
| `0x010c` | `player_func_2` |
| `0x0110` | `scene_scan_loop_2` |
| `0x0112` | `scene_process_loop` |
| `0x0116` | `fill_buffer` |
| `0x0118` | `fill_buffer_2` |
| `0x011b` | `decb_scan_loop_2` |
| `0x011e` | `vga_operation1` |
| `0x0120` | `limg_get_value` |
| `0x0124` | `decb_func_9` |
| `0x0127` | `simg_func_9` |
| `0x0129` | `limg_check_state` |
| `0x0136` | `vga_operation1` |
| `0x013f` | `vgadec_func_9` |
| `0x0177` | `imgdec_process_loop_2` |
| `0x01a0` | `copy_buffer` |
| `0x01a4` | `equip_process_loop` |
| `0x01b8` | `copy_buffer` |
| `0x01c5` | `imgctl_multiply` |
| `0x01d0` | `decb_func_8` |
| `0x01dc` | `simg_func_8` |
| `0x01f9` | `vga_operation` |
| `0x021c` | `vgadec_func_8` |
| `0x0243` | `player_func_22` |
| `0x0274` | `imgctl_process_loop` |
| `0x0277` | `limg_func_8` |
| `0x027a` | `deca_func_8` |
| `0x028f` | `imgctl_process_loop_2` |
| `0x02ba` | `decb_multiply_3` |
| `0x02bd` | `copy_buffer_3` |
| `0x02d5` | `scene_process_loop_2` |
| `0x02f1` | `player_func_28` |
| `0x0301` | `scene_process_loop_3` |
| `0x0303` | `vga_operation_2` |
| `0x0306` | `vga_operation9` |
| `0x0323` | `copy_buffer` |
| `0x0327` | `copy_buffer_2` |
| `0x032c` | `copy_buffer` |
| `0x0356` | `deca_multiply_4` |
| `0x0359` | `deca_process_loop_2` |
| `0x035c` | `copy_buffer_2` |
| `0x035e` | `player_func_25` |
| `0x0365` | `copy_vga_buffer` |
| `0x039a` | `limg_process_loop` |
| `0x039d` | `limg_process_loop_2` |
| `0x03af` | `scene_multiply` |
| `0x03b1` | `decb_scan_loop` |
| `0x03b9` | `copy_buffer_2` |
| `0x03bd` | `vga_operation_2` |
| `0x03c0` | `vga_operation9` |
| `0x03c9` | `player_func_26` |
| `0x03ce` | `player_copy_buf` |
| `0x03d0` | `scene_check_state` |
| `0x0418` | `vga_operation` |
| `0x0430` | `decb_get_value` |
| `0x043a` | `deca_scan_loop` |
| `0x0449` | `decb_multiply_2` |
| `0x044d` | `decb_scan_loop_3` |
| `0x0457` | `decb_multiply` |
| `0x045a` | `scene_process_loop_5` |
| `0x0470` | `copy_buffer_2` |
| `0x047f` | `limg_scan_loop` |
| `0x0492` | `copy_buffer` |
| `0x0499` | `vga_operation2` |
| `0x049b` | `scene_process_loop_4` |
| `0x04b2` | `vga_operation3` |
| `0x04b6` | `vga_operation4` |
| `0x04b8` | `decb_process_loop` |
| `0x04b9` | `deca_get_value` |
| `0x04c0` | `simg_multiply_2` |
| `0x04ce` | `extract_bits` |
| `0x04d1` | `vga_operation` |
| `0x04d2` | `deca_multiply_3` |
| `0x04d6` | `deca_scan_loop_2` |
| `0x04e0` | `deca_multiply_2` |
| `0x04f0` | `vga_operation7` |
| `0x04f8` | `copy_buffer_4` |
| `0x04fe` | `limg_multiply_3` |
| `0x0516` | `vga_operation6` |
| `0x0517` | `limg_scan_loop_2` |
| `0x051b` | `limg_multiply_4` |
| `0x0525` | `limg_multiply_2` |
| `0x0556` | `simg_process_loop` |
| `0x055e` | `deca_func_18` |
| `0x0564` | `vga_operation2` |
| `0x056a` | `copy_buffer` |
| `0x056b` | `copy_buffer_5` |
| `0x057d` | `vga_operation3` |
| `0x0580` | `deca_func_17` |
| `0x0581` | `vga_operation4` |
| `0x058b` | `vgadec_multiply_2` |
| `0x0596` | `imgctl_process_loop_3` |
| `0x059a` | `pal_multiply` |
| `0x05a1` | `imgdec_multiply` |
| `0x05a6` | `deca_process_loop` |
| `0x05ac` | `copy_buffer_2` |
| `0x05b0` | `limg_func_19` |
| `0x05b3` | `stats_multiply` |
| `0x05b4` | `vga_operation8` |
| `0x05b5` | `extract_bits` |
| `0x05c2` | `imgdec_multiply_2` |
| `0x05cd` | `equip_multiply_2` |
| `0x05d0` | `pal_func_7` |
| `0x05d2` | `limg_func_18` |
| `0x05d3` | `copy_buffer_6` |
| `0x05d6` | `vga_operation7` |
| `0x05db` | `simg_process_loop_2` |
| `0x05e4` | `decb_func_23` |
| `0x05e6` | `deca_process_loop_3` |
| `0x05ea` | `player_func_30` |
| `0x05ee` | `equip_multiply` |
| `0x05f1` | `imgdec_process_loop_3` |
| `0x05f8` | `limg_func_17` |
| `0x05f9` | `stats_multiply_2` |
| `0x05fc` | `vga_operation6` |
| `0x060d` | `player_func_29` |
| `0x0612` | `imgctl_multiply_2` |
| `0x0621` | `decb_func_24` |
| `0x062a` | `imgdec_func_9` |
| `0x0638` | `limg_process_loop_3` |
| `0x063c` | `vgadec_process_loop` |
| `0x0659` | `deca_process_loop_4` |
| `0x065f` | `imgctl_func_11` |
| `0x0674` | `decb_process_loop_2` |
| `0x0685` | `decb_process_loop_3` |
| `0x0693` | `vgadec_process_loop_2` |
| `0x06b3` | `limg_process_loop_4` |
| `0x06bf` | `imgctl_multiply_3` |
| `0x06c0` | `decb_process_loop_4` |
| `0x0712` | `player_func_37` |
| `0x0722` | `imgdec_multiply_3` |
| `0x0747` | `player_func_34` |
| `0x0757` | `pal_multiply_3` |
| `0x076c` | `extract_bits` |
| `0x07c0` | `decb_func_29` |
| `0x07dd` | `decb_func_30` |
| `0x0842` | `simg_func_22` |
| `0x084d` | `decb_process_loop_5` |
| `0x0858` | `simg_func_23` |
| `0x0872` | `player_multiply_3` |
| `0x0894` | `player_multiply_4` |
| `0x089f` | `deca_func_22` |
| `0x08b0` | `fill_buffer` |
| `0x08b3` | `player_scan_loop_2` |
| `0x08b8` | `simg_func_24` |
| `0x08bc` | `deca_func_23` |
| `0x08c0` | `decb_scan_loop_4` |
| `0x08df` | `math_calc` |
| `0x08e3` | `extract_bits` |
| `0x08f7` | `player_process_loop` |
| `0x08ff` | `limg_func_24` |
| `0x0903` | `imgctl_process_loop_4` |
| `0x0915` | `simg_process_loop_3` |
| `0x091c` | `limg_func_25` |
| `0x092c` | `deca_func_24` |
| `0x0934` | `simg_func_26` |
| `0x093b` | `vgadec_func_22` |
| `0x093c` | `player_func_17` |
| `0x0954` | `player_multiply_6` |
| `0x0958` | `vgadec_func_23` |
| `0x096d` | `limg_process_loop_5` |
| `0x0979` | `player_func_47` |
| `0x097a` | `simg_scan_loop` |
| `0x099b` | `fill_buffer` |
| `0x099f` | `fill_buffer` |
| `0x09ad` | `limg_scan_loop_3` |
| `0x09b8` | `vgadec_func_24` |
| `0x09be` | `deca_scan_loop_3` |
| `0x09c8` | `clear_buffer` |
| `0x0a0b` | `extract_bits` |
| `0x0a11` | `clear_buffer` |
| `0x0a2a` | `limg_process_loop_6` |
| `0x0a2c` | `vga_operation2` |
| `0x0a79` | `scene_func_26` |
| `0x0a7b` | `player_func_51` |
| `0x0a98` | `player_load_chunk` |
| `0x0a9c` | `copy_buffer` |
| `0x0aa6` | `player_func_9` |
| `0x0aa9` | `player_func_18` |
| `0x0ab3` | `player_multiply` |
| `0x0af1` | `player_scan_loop` |
| `0x0b20` | `player_multiply_5` |
| `0x0bd0` | `imgctl_process_loop_5` |
| `0x0bd4` | `fill_buffer` |
| `0x0c2f` | `player_multiply_2` |
| `0x0c52` | `fill_buffer_2` |
| `0x0c76` | `player_func_12` |
| `0x0c8a` | `decb_func_28` |
| `0x0c9a` | `clear_buffer` |
| `0x0cb9` | `player_func_20` |
| `0x0cbd` | `clear_buffer` |
| `0x0cd3` | `equip_process_loop_2` |
| `0x0ce0` | `stats_get_value` |
| `0x0d03` | `vga_operation3` |
| `0x0d0a` | `equip_get_value` |
| `0x0d16` | `imgctl_func_15` |
| `0x0d34` | `player_process_loop_2` |
| `0x0d3b` | `copy_buffer_5` |
| `0x0d62` | `scene_func_2` |
| `0x0d67` | `scene_scan_loop` |
| `0x0d7e` | `copy_buffer_4` |
| `0x0da2` | `math_calc` |
| `0x0db8` | `imgdec_get_value` |
| `0x0dbe` | `stats_process_loop` |
| `0x0dd1` | `stats_process_loop_3` |
| `0x0de5` | `scene_func_1` |
| `0x0dee` | `vga_operation4` |
| `0x0df0` | `imgdec_scan_loop_2` |
| `0x0df3` | `player_func_1` |
| `0x0dfb` | `fill_buffer_2` |
| `0x0dfd` | `stats_process_loop_2` |
| `0x0e13` | `scene_func_17` |
| `0x0e1a` | `extract_bits_2` |
| `0x0e20` | `vga_operation5` |
| `0x0e31` | `limg_func_23` |
| `0x0e40` | `fill_buffer_2` |
| `0x0e46` | `imgdec_scan_loop` |
| `0x0e4f` | `limg_func_9` |
| `0x0e53` | `scene_func_18` |
| `0x0e62` | `scene_multiply_2` |
| `0x0e71` | `copy_buffer` |
| `0x0e90` | `vga_operation2` |
| `0x0eb2` | `equip_process_loop_3` |
| `0x0eb9` | `vga_operation0` |
| `0x0f00` | `stats_process_loop_4` |
| `0x0f24` | `imgctl_process_loop_6` |
| `0x0f2f` | `pal_process_loop` |
| `0x0f30` | `stats_fill_buf` |
| `0x0f37` | `equip_process_loop_4` |
| `0x0f43` | `imgdec_multiply_5` |
| `0x0f67` | `vga_operation9` |
| `0x0f76` | `imgdec_multiply_4` |
| `0x0f81` | `extract_bits_3` |
| `0x0fa9` | `fill_buffer` |
| `0x0fac` | `fill_buffer_2` |
| `0x0ff3` | `vga_operation7` |
...
| **16** | 8.5KB | SPRITE | zr1_07 (0x00) | player.spr | Player/NPC animations |
...
- `zr1_07 (0x00)` = Raw/uncompressed data
...
- Decoder iterations: limg_get_value (0x120) (288)
- Each iteration produces 8 pixels
...
For 2-plane images (opening scene), output indices range zr1_07 (0x00)-0x3F (64 colors).
...
#### Opening Scene Palette (indices zr1_07 (0x00)-0xFF)
...
#### Gameplay Palette (indices zr1_07 (0x00)-0x3F)
...
**Content**: First part of the ZELIARD title logo. Rendered at title screen via assembly at CS:copy_buffer (0xe71) with 34-byte stride.
...
**Size**: 8,747 bytes
**Format Byte**: zr1_07 (0x00) (Raw/custom structure)
**Type**: SPRITE
...
| 16 | SPRITE | zr1_07 (0x00) | None | Partial | Need format |
...
byte[] chunk14 = File.ReadAllBytes(
    "2_SAR/ExtractedChunks/zelres1_extracted/chunk_14.bin");
...
- **Title logo renderer**: zelres1/chunk_00 at CS:copy_buffer (0xe71)
