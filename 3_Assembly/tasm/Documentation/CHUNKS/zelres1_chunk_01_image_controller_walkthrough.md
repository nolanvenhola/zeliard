...
### Main Entry Points (zr1_01 (0x0000)-0x0150)
...
## Section 2: VGA Address Calculation & Render Loop (imgctl_multiply (0x01c5)-0x0273)
...
### Scanline Render Loop (vga_operation (0x01f9)-0x0273)
...
## Section 3: Bitplane Copy Functions (imgctl_process_loop (0x0274)-0x02AA)

### Single Plane Fill (imgctl_process_loop (0x0274))
...
### Masked Plane Copy (imgctl_process_loop_2 (0x028f))
...
### Border/Effect Draw Function (imgctl_process_loop_4 (0x0903))
...
## Section 7: Sprite Animation System (0x03B1-copy_buffer (0x056a))
...
### Sprite Plane Renderer (imgctl_process_loop_3 (0x0596)-0x05B0)
...
### Simple 3-Plane Copy (vga_operation2 (0x0e90)-0x0EB8)
...
### Masked Copy with Gaps (vga_operation0 (0x0eb9)-0x0F23)
...
## Section 9: Box Drawing (imgctl_process_loop_6 (0x0f24)-0x0FB5)

### Decorative Border Renderer (imgctl_process_loop_6 (0x0f24)-0x0FA8)
...
| `0x4213` | 1 byte | Alpha/transparency flag (zr1_01 (0x00)=opaque, 0xFF=alpha) |
...
| Register | Purpose | Common Values |
|----------|---------|---------------|
| 0x03 | Function Select | zr1_01 (0x00)=replace, 0x10=XOR, 0x18=AND |
| 0x04 | Read Plane Select | zr1_01 (0x00)=plane0, 0x01=plane1, 0x02=plane2 |
| 0x05 | Mode Register | zr1_01 (0x00)=mode0, 0x02=mode2 (direct bitplane) |
